...
// Update the import path below if your DashboardContext is located elsewhere
...
const SummaryCards = () => {
  ...
  return (
    <div className="space-y-3 pb-2">
      ...
      {/* Main Content Grid */}
      <div className="flex flex-wrap xl:flex-nowrap gap-4 h-[130px] items-start">
        {/* Metric Cards */}
        ...
        {/* Active Filters Card */}
        <Card className="w-full max-w-[600px] border border-border bg-card shadow-lg rounded-2xl overflow-hidden">
          <div className="rounded-t-2xl bg-muted px-2 py-1 border-b border-border flex items-center justify-between">
            <h3 className="text-sm font-semibold text-card-foreground flex items-center gap-2">
              <Filter className="h-3 w-3" />
              Section Criteria
            </h3>
            <span className="text-xs text-slate-600 dark:text-slate-400">{totalActiveFilters} Active Filters</span>
          </div>
